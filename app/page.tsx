    ...
    <main className="flex min-h-screen flex-col p-2">
      ...
      <div className="mt-2 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-8 md:w-2/5 md:px-20">
          ...
          <Link
            href="/login"
            className="flex items-center gap-3 self-start rounded-lg bg-blue-500 px-4 py-3 text-xs font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
